...
class Diario(models.Model):
	realizado   	= models.IntegerField() #Fazer um count da tabela casos
	descartado   	= models.IntegerField() #Fazer um count da tabela casos
	...
	isolado 	   	= models.IntegerField()	#Fazer um count da tabela casos
	leito_suspeito  = models.IntegerField()	#Fazer um count da tabela casos
...
class Boletim(models.Model):
	...
	upload_em   = models.DateField('Criado em',default= timezone.now())
	status  	= models.BooleanField('Status', blank=True, default=True) 
